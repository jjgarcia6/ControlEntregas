...
class AuditLogItemResponse(BaseModel):
    ...
    accion: str = Field(..., description="Tipo de operación: CREATE | UPDATE | SOFT_DELETE | LOGIN")
    entidad: str = Field(..., description="Nombre de la entidad afectada (ej: xmls, entregas)")
    ...
    ip: str | None = Field(..., description="Dirección IP del cliente que originó la acción")
